...
class HEO_WC_Importer {
    ...
    public function __construct() {
        ...
        // add_filter('woocommerce_product_get_regular_price', [$this, 'custom_dynamic_price'], 20, 2);
        // add_filter('woocommerce_product_get_sale_price', [$this, 'custom_dynamic_price'], 20, 2);
...
// add_action('woocommerce_product_get_sale_price', function($price, $product) {
//     return 3; // fixed test price
// }, 10, 2);


// add_action('woocommerce_product_get_price', function($price, $product){
//     // error_log('Final price after other hooks: ' . $price);
//     return $price + 10;
// }, 10, 2);
